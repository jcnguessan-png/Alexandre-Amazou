    ...
    <div className="container py-16 md:py-20">
      ...
      <div className="prose-editorial mx-auto max-w-prose">
        ...
        <p>
          ...
          édité par le Pasteur Alexandre AMAZOU.
        </p>
        <p>
        ...
        <p>
          ...
          #4133, Walnut, CA 91789, États-Unis (ou tout autre hébergeur
          contractualisé ultérieurement).
        </p>

        <h2>Propriété intellectuelle</h2>
        <p>
          L'ensemble des contenus présents sur ce site (textes, images, vidéos,
          logos, charte graphique, code source) sont la propriété exclusive du
          Pasteur Alexandre AMAZOU ou de ses ayants droit. Toute reproduction,
        ...
        <p>
          ...
          <a href="https://abmci.com" target="_blank" rel="noopener noreferrer">abmci.com</a>{' '}
          et{' '}
          <a href={siteConfig.bookstoreUrl} target="_blank" rel="noopener noreferrer">
            librairie.abmci.com
          </a>
          . Le Pasteur Alexandre AMAZOU n'est pas responsable du contenu ni des
        ...
        <p>
          ...
          présentes conditions. Le Pasteur Alexandre AMAZOU se réserve le droit
          de modifier ces mentions à tout moment, sans préavis.
        </p>

        <h2>Droit applicable</h2>
        <p>
          Les présentes mentions sont régies par le droit ivoirien, notamment
          la loi n° 2013-450 du 19 juin 2013 relative à la protection des
          données à caractère personnel, ainsi que par le Règlement général
          européen sur la protection des données (RGPD) pour les visiteurs
          européens.
        </p>
